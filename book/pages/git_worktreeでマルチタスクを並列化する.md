...
```mermaid
graph TB
    A1[.gitディレクトリ] --> B1[ワーキングディレクトリ<br>※同時に1つのみ]
    B1 -. ブランチ切り替え .-> C1[main]
    B1 -. ブランチ切り替え .-> D1[feature/issue1]
    B1 -. ブランチ切り替え .-> E1[feature/issue2]

    style A1 fill:#4a5568,color:#fff,stroke:#2d3748
    style B1 fill:#e53e3e,color:#fff,stroke:#c53030
    style C1 fill:#718096,color:#fff,stroke:#4a5568
    style D1 fill:#718096,color:#fff,stroke:#4a5568
    style E1 fill:#718096,color:#fff,stroke:#4a5568
```
...
graph TB
    ...
    style A2 fill:#4a5568,color:#fff,stroke:#2d3748
    style B2 fill:#276749,color:#fff,stroke:#1c4532
    style C2 fill:#276749,color:#fff,stroke:#1c4532
    style D2 fill:#276749,color:#fff,stroke:#1c4532
```
