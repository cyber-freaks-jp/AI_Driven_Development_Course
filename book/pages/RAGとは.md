...
![RAGとは プロンプト1](images/RAGとは_prompt_1.png)

**2. 社内の情報**

あなたの会社の業務マニュアルや、プロジェクトの仕様書は、LLMの学習データに含まれていません。

![RAGとは プロンプト2](images/RAGとは_prompt_2.png)

**3. 非公開のドキュメント**

あなたが今開発しているプロジェクトのREADMEや、設計書などは、LLMは読んだことがありません。

![RAGとは プロンプト3](images/RAGとは_prompt_3.png)
...
![RAGとは プロンプト4](images/RAGとは_prompt_4.png)
...
**事前準備（最初に一度だけ）：**
![RAGとは プロンプト5](images/RAGとは_prompt_5.png)

**実際に質問するとき：**
![RAGとは プロンプト6](images/RAGとは_prompt_6.png)
...
![RAGとは プロンプト7](images/RAGとは_prompt_7.png)

### RAG + AIエージェント

RAGとAIエージェントを組み合わせると、「情報を取ってきて、実際に実行する」ことができます。

![RAGとは プロンプト8](images/RAGとは_prompt_8.png)
