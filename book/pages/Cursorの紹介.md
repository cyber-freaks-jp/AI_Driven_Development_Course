...
## 2.cursorrulesでプロジェクトのルールを設定

Cursorには、プロジェクト固有のルールを設定できる機能があります。

プロジェクトのルートディレクトリに `.cursorrules` ファイルを作成すると、AIがそのルールに従ってコードを生成します。
...
このファイルを設定することで、AIが自動的にプロジェクトのルールに従ったコードを生成してくれます。
