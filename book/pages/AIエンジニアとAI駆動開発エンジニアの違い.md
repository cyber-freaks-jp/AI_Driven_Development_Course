...
これまでAIの基本とその種類について学んできました。ここで多くの方が疑問に思うことがあります。「AIエンジニアになるには、難しい数学を勉強しないといけないの？」という質問です。

実は、AI分野には2つの異なる役割があります。それが「AIエンジニア」と「AI駆動開発エンジニア」です。この2つは名前が似ていますが、求められるスキルも役割も全く異なります。

## 2つのエンジニアの全体像

まず、AIエンジニアとAI駆動開発エンジニアの違いを図で見てみます。

```mermaid
graph TD
    subgraph AIエンジニア["AIエンジニア (AIを育てる側)"]
        A1[機械学習モデルの開発]
        A2[モデルの学習]
        A3[モデルの最適化]
        A4[研究開発]
    ...
    subgraph AI駆動開発エンジニア["AI駆動開発エンジニア (AIを使う側)"]
        B1[既存AIツールの活用]
        B2[プロンプトの作成]
        B3[開発作業の効率化]
        B4[アプリケーション開発]
...
大きな違いは、「AIを作る側」か「AIを使う側」かという点です。

## AIエンジニア：AIを育てる側

AIエンジニアは、AI自体を開発する専門家です。ChatGPTやGitHub CopilotのようなAIツールを作る側の人たちです。
