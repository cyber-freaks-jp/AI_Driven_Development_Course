...
一方、AIは違います。たくさんのデータを与えることで、自分でパターンを見つけて学習します。まるで、あなたが経験を積んで仕事を覚えていくように、AIもデータという経験から学んでいきます。

## 身近な例で理解するAI

あなたは毎日、知らず知らずのうちにAIを使っています。

**YouTubeのおすすめ動画**で考えてみましょう。あなたが見た動画の履歴から、次に見たくなりそうな動画を予測して表示してくれます。

これはAIが「この人はこの動画が見た」というパターンから学習した結果、「こういう動画も好きであろう」と予測するのです。

![そもそもAIって何？ 図1](images/what-is-ai_1.png)
