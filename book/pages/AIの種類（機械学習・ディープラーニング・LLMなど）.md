...
この章では、AI技術の全体像と、それぞれの技術の違いを学びました。
...
内側に行くほど専門化し、AI駆動開発に直結します。

### 技術とモデルの違い

- **技術**：学習の方法（機械学習、ディープラーニング、LLMなど）
- **モデル**：学習の成果物（GPT-4、Claude 3.5 Sonnetなど）

### 生成AIとLLMの違い

- **生成AI**：あらゆるコンテンツを生成するAI全般（画像、音声、テキストなど）
- **LLM**：生成AIの中でテキストに特化したもの

AI駆動開発では、主にLLMを使います。なぜなら、開発で扱うもの（コード、ドキュメント、設計書など）の多くがテキストだからです。

### AI駆動開発で重要なこと

1. **適切なモデルを選ぶ**：タスクに応じて性能、速度、コストのバランスを考える
2. **LLMの特徴を理解する**：各モデルの得意分野を知る
3. **技術の階層を理解する**：AIの全体像を把握することで、効果的に活用できる

次の章では、これらの技術を実際の開発でどう活用するかを学んでいきます。
