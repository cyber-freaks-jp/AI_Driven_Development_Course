...
AIの手が届くところに、機密情報を置くのは運用で禁止します。つまり、AIは通信が隔離されたサンドボックス上でのみ動かし、そこには機密情報を置かないルールにします。
...
そのためにも、サンドボックス環境は本番環境に通信できないよう隔離します。もちろんSSH接続も出来ないようにします。

## メリット2：生産性の爆発的向上

通常、AIは危険なコマンドを実行する際、人間に確認を求めます：

![AIはサンドボックス環境で動かすのがオススメ プロンプト1](images/AIはサンドボックス環境で動かすのがオススメ_prompt_1.png)
...
![AIはサンドボックス環境で動かすのがオススメ コード1](images/AIはサンドボックス環境で動かすのがオススメ_code_1.png)
...
![AIはサンドボックス環境で動かすのがオススメ コード2](images/AIはサンドボックス環境で動かすのがオススメ_code_2.png)
